...
`;
        ...
        await step.run("send-welcome-email", async () => {
            ...
            const introText =
                ...
                "Thanks for joining HyperStocks. You now have the tools to track markets and make smarter moves.";
...
/* =====================================================
   Daily watchlist-based news summary
===================================================== */
